<?php $__env->startSection('title'); ?>
    <?php echo e('ادارة الميزانية العمومية'); ?>
                    ...
                    <div id="vertical-example" class="vertical-wizard">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="cost[]"  value="<?php echo e($balance->cost); ?>" class="form-control" id="verticalnav-pancard-input">
                                                            <span class="text-danger error-text item_error"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <div class="mb-3 price">
                                                            ...
                                                            <input type="text" name="quantity[]" value="<?php echo e($balance->quantity); ?>" onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="depreciation[]"  value="<?php echo e($balance->depreciation); ?>" onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                        ...
                        <section id="forms_2">
                            ...
                            <form id="form_2" name="form_2" class="form-horizontal">
                                ...
                                <div class="row">
                                    <?php if($balances->where('balance_type', 'transport')->isNotEmpty()): ?>
                                                <?php $__currentLoopData = $balances->where('balance_type', 'transport'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="mb-3">
                     ...
                     <tbody id="transport_depreciationsss">
                        ...
                        <section>
                            ...
                            <form id="form_3" name="form_3" class="form-horizontal">
                                ...
                                <div class="row">
                                    <?php if($balances->where('balance_type', 'equipments')->isNotEmpty()): ?>
                                                <?php $__currentLoopData = $balances->where('balance_type', 'equipments'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="mb-3">
                        ...
                        <section>
                            ...
                            <div class="row">
                                <?php if($balances->where('balance_type', 'furniture')->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $balances->where('balance_type', 'furniture'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                        ...
                        <section>
                            ...
                            <div class="row">
                                <?php if($balances->where('balance_type', 'intangible_assets')->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $balances->where('balance_type', 'intangible_assets'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                        ...
                        <section>
                            ...
                            <div class="row">
                                <?php if($balances->where('balance_type', 'other_assets')->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $balances->where('balance_type', 'other_assets'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                        ...
                        <section>
                            ...
                            <form id="form_7" name="form_7" class="form-horizontal">
                                <?php if($balances->where('balance_type', 'reserve')->isNotEmpty()): ?>
                                <?php $__currentLoopData = $balances->where('balance_type', 'reserve'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="">
                                    <div class="mb-3">

                                        <label for="verticalnav-pancard-input"><strong>نسبة الاحتياطي</strong></label>

                                        <input type="text" name="cost"  value="<?php echo e($balance->cost); ?>" onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                                        <span class="text-danger error-text _error"></span>
                                    </div>
                                        </div >
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Documents/GitHub/jadwa_new/resources/views/admin/balance_sheet/index.blade.php ENDPATH**/ ?>