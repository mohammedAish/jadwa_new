                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?php echo e(route('saleChanel.index')); ?>" id="newModalForm"  onsubmit="return check()">
                                                            <?php echo csrf_field(); ?>
                                                           ...
                                                           <input type="hidden" name="type" class="form-control" id="type" value="<?php echo e('sale_channel'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwahmad\resources\views/admin/SaleChannel/index.blade.php ENDPATH**/ ?>