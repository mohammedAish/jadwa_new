                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                        ...
                                        <button type="button" class="btn btn-success bg-o waves-effect waves-light mb-2 me-2 yello" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">اضافة جديد</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?php echo e(route('projectype.store')); ?>" id="newModalForm">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="form-check">
                                                                    <div class="btn-group-horizontal validate" role="group" aria-label="Horizontal radio toggle button group" >
                                                                        <input type="radio" class="btn-check" name="status" value="active" id="active-radio1"  >
                                                                        <label class="btn btn-outline-success" for="active-radio1">نشط</label>
                                                                        <input type="radio" class="btn-check" name="status" value="inactive" id="active-radio2" >
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwahmad\resources\views/admin/ProjectType/index.blade.php ENDPATH**/ ?>