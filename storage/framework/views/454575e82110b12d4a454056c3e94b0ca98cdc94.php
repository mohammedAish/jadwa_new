...
<?php $__env->startSection('title'); ?>  مصادر الايرادات <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?>  <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?>   مصادر الايرادات <?php $__env->endSlot(); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <form method="POST" action="<?php echo e(route('search_incomSourc')); ?>"  >
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('incomSourc.index')); ?>" id="newModalForm">
                                                    <div class="modal-body">
                                                           ...
                                                           <input type="hidden" name="type" class="form-control" id="type" value="<?php echo e('income_sources'); ?>">
                    ...
                    <?php if(isset($incomSourc)): ?>
                    <?php if($incomSourc->count() > 0): ?>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap table-check">
                            ...
                            <?php $__currentLoopData = $incomSourc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tbody class="bg-p">
                                <tr>
                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   <form method="POST" action="incomSourc/{incomSourc}" id="editModal">
                                        <?php echo csrf_field(); ?>
 ...
 title: "Please enter the title",
        ...
        $('.table-responsive').on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (status.value) {
                        $.ajax({
                            url: '<?php echo e(url('incomSourc/{incomSourc}')); ?>',
                            type: 'Delete',
                            data: {
                                'id': id,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwahmad\resources\views/admin/IncomeSources/index.blade.php ENDPATH**/ ?>