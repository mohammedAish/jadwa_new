                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('marktchanl.index')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3">
                                                    ...
                                                    <a  title="تعديل" style="cursor: pointer" class="text-success"  data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>"
    ...
    <script>
        ...
        $('.table-responsive').on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (status.value) {
                        $.ajax({
                            url: '<?php echo e(url('marktchanl/{marktchanl}')); ?>',
                            type: 'Delete',
                            data: {
                                'id': id,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/MarketChanel/index.blade.php ENDPATH**/ ?>