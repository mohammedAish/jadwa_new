                    ...
                    <div id="vertical-example" class="vertical-wizard">
                        ...
                        <section>
                            ...
                            <form id="form1" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3 <?php $__errorArgs = ['minimum_cash'];
...
unset($__errorArgs, $__bag); ?>">
                                           ...
                                           <div class="row " id="selectInputt">
                                               ...
                                               <div class="col-md-12 minimum_cash">
                                                 <?php if(isset($fundingSources[0])): ?>
                                                       <input type="text" name="minimum_cash" value="<?php echo e($fundingSources[0]->minimum_cash); ?>" class="form-control validate" id="verticalnav-pancard-input">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3 <?php $__errorArgs = ['interest_rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <div class="col-md-12 interest_rate" >
                                                <?php if(isset($fundingSources[0])): ?>
                                                    ...
                                                    <input type="text" name="interest_rate" value="<?php echo e($fundingSources[0]->interest_rate); ?>" class="form-control validate" id="verticalnav-pancard-input">
                                            ...
                                            <div class="row " id="selectInputt3">
                                                <div class="col-md-6">
                                                    <div class="form-check form-check-warning mb-3">
                                                        <?php if(isset($fundingSources[0])): ?>
                                                            <input class="form-check-input "  type="checkbox"  id="chkCache" <?php echo e($fundingSources[0]->minimum_cash?'':'checked'); ?> onclick="ShowHideDiv(this)" >
                                    ...
                                    <tr style="background: rgba(244, 244, 244, 0.5);  ">
                                        ...
                                        <tr style=" border: white;">
                                            ...
                                            <td> <div class="col-6 interest">
                                                    <?php if(isset($loanDetails[0])): ?>
                                                        <div class="input-group">
                                                        <input type="text" name="interest" value="<?php echo e($loanDetails[0]->interest); ?>" class="form-control validate" id="verticalnav-pancard-input">
                                                        <span
                                                            class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"
                                                            id="formrow-vat-input"><span class="input-group-text"
                                                                                         style="background-color: #f4f4f480; color:black;font-weight: bold;">%</span></span>
                                                    ...
                                                    <?php else: ?>
                                                    <div class="input-group">
                                                        <input type="text" name="interest" class="form-control validate" value="<?php echo e(old('interest')); ?>" id="verticalnav-pancard-input">
                                                        <span
                                                            class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"
                                                            id="formrow-vat-input"><span class="input-group-text"
                                                                                         style="background-color: #f4f4f480; color:black;font-weight: bold;">%</span></span>
                                        ...
                                        <tr style=" border: white;">
                                            ...
                                            <td> <div class="col-6 self_financing">
                                                    <?php if(isset($loanDetails[0])): ?>
                                                        <input type="text" name="administrative_expenses" value="<?php echo e($loanDetails[0]->administrative_expenses); ?>" class="form-control validate" id="verticalnav-pancard-input">
                                                        <span class="text-danger error-text administrative_expenses_error"></span>

                                                    <?php else: ?>
                                                        <input type="text" name="administrative_expenses" class="form-control validate" value="<?php echo e(old('administrative_expenses')); ?>" id="verticalnav-pancard-input">
                                                        <span class="text-danger error-text administrative_expenses_error"></span>
...
unset($__errorArgs, $__bag); ?>"
                                                                       id="start_date" name="start_date" value="<?php echo e($loanDetails[0]->start_date); ?>"
                                                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                                                       id="start_date" onchange="mysummation()" name="start_date" value="<?php echo e(old('start_date')); ?>"
                                                                       required>
                                                                <span class="text-danger error-text start_date_error"></span>
                                                            <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/libs/datepicker/datepicker.min.js')); ?>"></script>
    <!-- form wizard init -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Documents/GitHub/jadwa_new/resources/views/admin/FundingSource/create.blade.php ENDPATH**/ ?>