                                            ...
                                            <form method="POST" action="<?php echo e(route('incomSourc.index')); ?>" id="newModalForm">
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="type" class="form-control" id="type"
                                                        value="<?php echo e('income_sources'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\jadwahmad\resources\views/admin/IncomeSources/index.blade.php ENDPATH**/ ?>