                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                        ...
                                        <button type="button" class="btn btn-success  waves-effect waves-light mb-2 me-2 bg-o" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">اضافة جديد</button>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?php echo e(route('contacts.store')); ?>">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" name="value" id="value" required><?php echo e(old('value')); ?></textarea>
                                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>