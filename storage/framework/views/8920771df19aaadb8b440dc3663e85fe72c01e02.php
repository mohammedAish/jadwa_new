                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo e(route('adminstExp.store')); ?>"
                                                    id="addForm">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="item"
                                                            class="form-control <?php $__errorArgs = ['item'];
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/AdminstratorExp/index.blade.php ENDPATH**/ ?>