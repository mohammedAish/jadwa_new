                                            ...
                                            <form method="POST" action="<?php echo e(route('expensisModel.index')); ?>"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="type" class="form-control" id="type"
                                                        value="<?php echo e('expensis_modal'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\jadwahmad\resources\views/admin/ExpensisModal/index.blade.php ENDPATH**/ ?>