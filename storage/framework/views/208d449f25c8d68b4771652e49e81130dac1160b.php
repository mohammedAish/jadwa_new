    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="<?php echo e(route('profile' , Auth::user()->id)); ?>"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">ملفي الشخصي</span></a>
...
<?php /**PATH /Users/mac/Desktop/valet project/jadwaa/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>