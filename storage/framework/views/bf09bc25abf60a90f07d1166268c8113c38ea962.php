                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('incomSourc.index')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3">
                                                    ...
                                                    <a  title="تعديل" class="text-success" style="cursor: pointer"  data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/IncomeSources/index.blade.php ENDPATH**/ ?>