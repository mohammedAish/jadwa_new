...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <label class="form-label colors fon">رقم الجوال</label>
                                                <div class="input-group auth-pass-inputgroup ">
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('phone')); ?>"  placeholder="ادخل رقم الجوال"
                                                        autocomplete="email" autofocus>
                                                    <button class="btn btn-light"  type="button">
                                                        <select class="btn btn-light" style="width: 80px" name="countryCode" id="">
                                                            <option data-countryCode="SA" selected value="966">Saudi Arabia (+966)
                                                            </option>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <button class="btn btn-light " id="show" type="button"
                                                            id="password-addon"><i
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mt-3 text-center yell">
                                                <p>هل لديك حساب ؟ <a href="<?php echo e(url('login')); ?>" class="fw-medium  yell">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/auth/register.blade.php ENDPATH**/ ?>