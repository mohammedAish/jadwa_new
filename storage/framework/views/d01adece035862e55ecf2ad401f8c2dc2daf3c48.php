...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>  اعدادات النظام   >  الصفحات <?php $__env->endSlot(); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('pages.create')); ?>"
                                   class="btn btn-success bg-o waves-effect waves-light mb-2 me-2"> إضافة  جديد <i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="<?php echo e(route('pages.edit',$page)); ?>" title="تعديل" class="text-success"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>