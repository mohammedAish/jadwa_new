                                ...
                                <table data-repeater-item  class="table table-bordered text-center inner-repeater " id="summry_table">
                                    ...
                                    <?php if(isset($projectIncomes)): ?>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="12"
                                                    class="text-center font-weight-bold " id="emptyincome" style="color:   rgba(10, 10, 10, 0.6);font-weight: 500"><?php echo e('أضف منتجات / خدمات مشروعك'); ?></td>
            ...
            jQuery('#value_incremental_button').click(function (e) {
                ...
                jQuery.ajax({
                 ...
                 <tr style=" ">\
                     ...
                     <td>` <input type="hidden" name="year[]" value="<?php echo e($year); ?>" />\
