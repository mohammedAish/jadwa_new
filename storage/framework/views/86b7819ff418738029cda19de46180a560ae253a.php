    ...
    <div class="row">
        ...
        <div class="col-lg-4">
                        ...
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <p class="text-black mb-0 gray"><?php echo e($operationDate); ?></p>
                                        </div>
                    </div>
                    </td>
                    </tr>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <p class="text-black mb-0 gray"><?php echo e($remainingDays); ?> يوم</p>
                    </div>
        </div>
        </td>
        </tr>
        <tr>
            ...
            <td>
                <div>
                    <p class="text-black mb-0 gray"><?php echo e($remainingmonths); ?> أشهر</p>
                </div>
    </div>
    </td>
    </tr>
    ...
    <div class="row">
        ...
        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4">
                <!-- Simple card -->
                <div class="card">
                    <img class="card-img-top img-fluid" src="<?php echo e(url('public/image/' . $service->image)); ?>"
                        alt="Card image cap">
                    <div class="card-body">

                        <h4 class="card-title mt-0 " style="display: -webkit-inline-box;"><?php echo e($service->title); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/valet project/jadwaa/resources/views/admin/projects/show.blade.php ENDPATH**/ ?>