                                            ...
                                            <form method="POST" action="contacts/{contact}" id="editModal">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="type" class="form-select" name="type">
                                                        <option selected disabled hidden value="<?php echo e($contact->type); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\jadwahmad\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>