...
<?php $__env->startSection('title'); ?> <?php echo e('تعديل بيانات المستخدم'); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> المستخدمين <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> تعديل بيانات المستخدم <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($user->name); ?>" id="formrow-firstname-input" placeholder="قم بإدخال الاسم">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($user->email); ?>" id="formrow-email-input" placeholder="قم بإدخال البريد الإلكتروني">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e($user->phone); ?>" id="formrow-email-input" placeholder="قم بإدخال رقم الجوال">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                        ...
                                        <select id="type" class="form-select" name="type">
                                            <option selected hidden value="<?php echo e($user->gender); ?>"><?php echo e($user->gender == 'male' ? 'ذكر' : 'أنثى'); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwahmad\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>