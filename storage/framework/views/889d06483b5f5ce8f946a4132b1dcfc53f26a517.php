<?php $__env->startSection('title'); ?> مصاريف ادارية  <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?>  <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?>  مصاريف ادارية <?php $__env->endSlot(); ?>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?php echo e(route('adminstExp.store')); ?>"id="newModalForm">
                                                            <?php echo csrf_field(); ?>
                                                           
                                                            <div class="mb-3">
                                                                <label for="item" class="col-form-label flex">البند</label>
                                                                <input type="text" name="item" class="form-control validate" id="item" value="<?php echo e(old('item')); ?>" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3">
                                                    ...
                                                    <a  title="تعديل" class="text-success"  data-bs-toggle="modal" data-id="<?php echo e($adminstExp->id); ?>" 
                                         ...
                                         <a  title="حذف" style="cursor: pointer"  data-id="<?php echo e($adminstExp->id); ?>"  class="text-danger delete">
                                            <i
                                   ...
                                   <form method="POST" action="adminstExp/{adminstExp}" id="editModal">
                                        ...
                                        <input type="hidden" id="id" name="id">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="text" name="item" class="form-control" id="item" value="<?php echo e($adminstExp->item); ?>">
                                        </div>  
                
                                        <div class="mb-3">
                                            <label for="value" class="col-form-label">القيمة</label>
                                            <input type="text" name="value" class="form-control" id="value" value="<?php echo e($adminstExp->value); ?>">
                                        </div>  
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwahmad\resources\views/admin/AdminstratorExp/index.blade.php ENDPATH**/ ?>