...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> اعدادات النظام > الخدمات <?php $__env->endSlot(); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('services.create')); ?>"
                                        class="btn btn-success  waves-effect waves-light mb-2 me-2 bg-o"> إضافة خدمة جديد <i
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="<?php echo e(route('services.edit', $services->id)); ?>" title="تعديل" class="text-success"><i
                                                ...
                                                <a  title="حذف" style="cursor: pointer"  data-id="<?php echo e($services->id); ?>"  class="text-danger delete">
                                                    <i
                                                        class="mdi mdi-delete font-size-20"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/services/index.blade.php ENDPATH**/ ?>