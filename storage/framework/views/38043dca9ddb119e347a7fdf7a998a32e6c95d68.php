<?php $__env->startSection('title'); ?> قنوات التسويق <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?>  <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> قنوات التسويق<?php $__env->endSlot(); ?>
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('marketchanel.index')); ?>" id="newModalForm"  onsubmit="return check()">
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="project_type_id" class="col-form-label flex">نوع المشروع</label>
                                                                    <!-- All countries -->
                                                           ...
                                                           <input type="hidden" name="type" class="form-control" id="type" value="<?php echo e('marketing_channel'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwahmad\resources\views/admin/MarketChanel/index.blade.php ENDPATH**/ ?>