                                            ...
                                            <form method="POST" action="<?php echo e(route('mainActivity.index')); ?>"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="type" class="form-control" id="type"
                                                        value="<?php echo e('main_activity'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\jadwahmad\resources\views/admin/mainActivity/index.blade.php ENDPATH**/ ?>