                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?php echo e(route('projectype.store')); ?>">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="title" style="text-align: rigth !important" class="col-form-label flex">العنوان</label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwa\resources\views/admin/ProjectType/index.blade.php ENDPATH**/ ?>