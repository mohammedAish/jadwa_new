                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="job[]"  value="{{$employee->job}}" class="form-control" id="verticalnav-pancard-input">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mb-3 price">
                                                            ...
                                                            <input type="text" name="quantity[]" value="{{$employee->quantity}}" onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="annual_salary[]"  value="{{$employee->annual_salary}}" onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="value_incremental[]"  value="{{$employee->value_incremental}}"  onkeypress="return isNumber(event)" class="form-control" id="verticalnav-pancard-input">
                                                            <span class="text-danger error-text quantity_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
