        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('search_mainActivity') }}">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('mainActivity.index') }}"
                                                id="newModalForm">
                    ...
                    @if ($mainActivity->count() > 0)
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-check">
                                ...
                                @foreach ($mainActivity as $key => $item)
                                    <tbody class="bg-p">
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $item->title }}</td>
    ...
    <script>
        ...
        $('.table-responsive').on('click', '.delete', function() {
            ...
            swal.fire({
                ...
                if (status.value) {
                    $.ajax({
                        url: '{{ url('mainActivity/{mainActivity}') }}',
                        type: 'Delete',
                        data: {
                            'id': id,
                            '_token': '{{ csrf_token() }}',
