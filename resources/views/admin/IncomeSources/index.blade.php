        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('search_incomSourc') }}">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('incomSourc.index') }}" id="newModalForm">
                    ...
                    @if ($incomSourc->count() > 0)
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-check">
                                ...
                                @foreach ($incomSourc as $key => $item)
                                    <tbody class="bg-p">
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $item->title }}</td>
