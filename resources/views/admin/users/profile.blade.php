                    ...
                    <div class="card-body">
                        <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" name="name"
                                                placeholder="الاسم كامل" value="{{ $user->name }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email"
                                                    placeholder="jadwacloud@gmail.com"  value="{{ $user->email }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="phone" class="form-control" name="phone"
                                                    placeholder="4567 123 598 966"  value="{{ $user->phone }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="whatsapp"
                                                    placeholder="رابط الواتساب"  value="{{ $user->whatsapp }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="linkedin"
                                                    placeholder="رابط لينكد ان"  value="{{ $user->linkedin }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" id="gender" name="gender">
                                                    ...
                                                    <option @if($user->gender == "female") selected @endif value="female">انثى</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="b" role="tabpanel"
                                ...
                                @endif
                                    <form class="form-horizontal" method="POST"
                                    action="{{ route('edit_password') }}">
                                    @csrf
                                        <label class="col-md-2 col-form-label">كلمة المرور القديمة</label>
                                        <div class="form-group row mb-4">
                                            <div
                                                class="input-group auth-pass-inputgroup @error('old_password') is-invalid @enderror">
                                        ...
                                        <div class="form-group row mb-4">
                                            <div
                                                class="input-group auth-pass-inputgroup @error('confirm_password') is-invalid @enderror">
                                        ...
                                        <div class="col-md-6 col-6" style="float: left">
                                            <button type="submit" style="float: left"
                                                class="btn btn-outline-warning col-md-6" id="save2">تغيير كلمة المرور </button>
                                        </div>
                                        <br><br>
                                    </form>
                                </div>
