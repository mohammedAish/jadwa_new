    ...
    <script>
        $(document).ready(function() {
            ...
            $('#save_btn_1').click(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('project_administrative_expenses.store') }}",
                    method: 'post',
            ...
            $('#save_btn_2').click(function(e) {
                ...
                jQuery.ajax({
                    url: "{{ route('project_fs_general_expenses_incremental') }}",
                    method: 'post',
                    data: formData,
                    dataType: 'json',
            ...
            $('#save_btn_7').click(function(e) {
                ...
                jQuery.ajax({
                    url: "{{ route('project_fs_utilities_incremental') }}",
                    method: 'post',
                    data: formData,
                    dataType: 'json',
                    success: function(result) {
            ...
            $('#save_btn_11').click(function(e) {
                ...
                jQuery.ajax({
                    url: "{{ route('project_fs_other_expenses_incremental') }}",
                    method: 'post',
                    data: formData,
                    dataType: 'json',
                    success: function(result) {
            ...
            function fetchExpenses() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('fetch_administrative_expenses') }}",
                    data: {id: id},
                    dataType: "json",
                                    ...
                                    $('#table_expenses').append('<div class="row" id="table_exp">\
                                        <table class="GeneratedTable" id="incremental_summry_table">\
                                            ...
                                            <tbody id="view_incremental_data">\
                                                    ...
                                                    <th id="total_expenses">'+response.data.value /100 * 500000+'</th>\
                                            </tbody>\
                                        </table></div>');
                            }
            ...
            function fetchExpensesIncremintal() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('fetch_administrative_expenses_incremintal') }}",
                    data: {id: id},
                    dataType: "json",
                    success: function (response) {
            ...
            function fetchOtherIncremintal() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('fetch_other_incremintal') }}",
                    data: {id: id},
                    dataType: "json",
                    success: function (response) {
                        console.log(response);
                        ...
                        $('#table_rent_details').html("");
                            ...
                            if(response.data.type == "custom"){
                                $('#table_rent_details').append('<div class="row" id="table_ren_details">\
                                    ...
                                    $.each(response.item, function(prefix, val) {
                                        // console.log(response);
                                    $('#view_rent_data').append('<tr>\
                                                    <th id="title_expenses">' + formatter.format(val) + '</th>\
                                                    <th id="th_expenses1">' + formatter.format(val) + '</th>\
                                                    <th id="th_expenses2"></th>\
            ...
            function fetchUtilitiesDetails() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('fetch_utilities_details') }}",
                    data: {id: id},
                    dataType: "json",
                    success: function (response) {
                        // console.log(response);
            ...
            function fetchMarketnigDetails() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('fetch_marketing_details') }}",
                    data: {id: id},
                    dataType: "json",
                    success: function (response) {
                        // console.log(response);
