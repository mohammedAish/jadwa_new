                                    ...
                                    <div data-repeater-item class="inner mb-3 row marketing_channels">
                                        <div class="col-md-12 col-8">
                                            <select name="marketing_channels[]" type="text" class="inner form-control">
                                                <option selected disabled> -- إختر -- </option>
                                                @foreach($marketing_channels as $chanel)
                                                    <option value="{{$chanel->id}}"> {{$chanel->title}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div data-repeater-item class="inner mb-3 row expenses_modal">
                                        <div class="col-md-12 col-8">
                                            <select name="expenses_modal[]" type="text" class="inner form-control">
                                                <option selected disabled> -- إختر -- </option>
                                                @foreach($expenses_modal as $model)
                                    ...
                                    <div data-repeater-item class="inner mb-3 row main_activity">
                                        <div class="col-md-12 col-8">
                                            <select name="main_activity[]" type="text" class="inner form-control">
                                                <option selected disabled> -- إختر -- </option>
                                                @foreach($main_activity as $activity)
...
{{--                                        @foreach($project_product_details as $key => $item)--}}
{{--                                            <tr>--}}
{{--                                                <th>{{$key+1}}</th>--}}
{{--                                                <td>{{$item->name}}</td>--}}
{{--                                                <td>{{$item->details}}</td>--}}
{{--                                                <td>--}}
{{--                                                    <a title="تعديل" class="text-success" data-bs-toggle="modal" data-id="{{$item->id}}" data-name="{{$item->name}}" data-details="{{$item->details}}"--}}
{{--                                                       href="#editModal"><i--}}
                                        ...
                                        <div class="modal-body">
                                            <form id="createModalForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('details') is-invalid @enderror" name="details" id="details" required>{{ old('details') }}</textarea>
                                                    @error('details')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.id == 'add_competitor') {
                ...
                $(".competitors").after(`<div data-repeater-item class="inner mb-3 row ">
                                <div class="input-group col-md-12 col-8 auth-pass-inputgroup @error('competitors') is-invalid @enderror">
            ...
            if (e.target.id == 'add_marketing_channel') {
                $(".marketing_channels").after(`<div data-repeater-item class="inner mb-3 row ">
                                <div class="input-group col-md-12 col-8 auth-pass-inputgroup @error('marketing_channels') is-invalid @enderror">
...
`);
            ...
            if (e.target.id == 'add_income_source') {
                $(".income_sources").after(`<div data-repeater-item class="inner mb-3 row ">
                                <div class="input-group col-md-12 col-8 auth-pass-inputgroup @error('income_sources') is-invalid @enderror">
            ...
            if (e.target.id == 'add_expenses_modal') {
                $(".expenses_modal").after(`<div data-repeater-item class="inner mb-3 row ">
                                <div class="input-group col-md-12 col-8 auth-pass-inputgroup @error('expenses_modal') is-invalid @enderror">
            ...
            if (e.target.id == 'add_main_activity') {
                $(".main_activity").after(`<div data-repeater-item class="inner mb-3 row ">
                                <div class="input-group col-md-12 col-8 auth-pass-inputgroup @error('main_activity') is-invalid @enderror">
